...
#pragma link C++ class RooStats::MinFinder+;
#pragma link C++ class RooStats::MinFinderStandard+;
#pragma link C++ class RooStats::MinFinderScan+;
...
#pragma link C++ function RooStats::Minimize(RooAbsReal&);
